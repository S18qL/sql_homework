...
SELECT country FROM customers WHERE country IN ( SELECT country FROM suppliers) AND country IN ( SELECT country FROM employees);
...
SELECT DISTINCT(country) FROM customers WHERE country IN( SELECT country FROM suppliers) AND country NOT IN (SELECT country FROM employees);
